...
public class PostPopulationFrequencies implements Callable<Integer> 
{
	 ...
	 *
	 * @param gtRegistry The genotyping registry label for the data set to be uploaded.
	 * @param estEntity The estimation entity (who did the analysis) label for the data 
	 * set to be uploaded.
	...
	public PostPopulationFrequencies(String gtRegistry, String estEntity) //File inputFile, 
		...
		this.url = new URL(Prefs.getDatabaseUrl());
